...
class CalibrationWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, app):
        ...
        super(CalibrationWindow, self).__init__(title='Calibração', application=app)
        self.set_modal(True)
        ...
        self.saved_calibration_date_label = builder.get_object('saved_calibration_date_label')
        self.saved_calibration_label = builder.get_object('saved_calibration_label')
        self.new_calibration_date_label = builder.get_object('new_calibration_date_label')
        self.new_calibration_label = builder.get_object('new_calibration_label')
        ## Spins
