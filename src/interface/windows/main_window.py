...
class MainWindow(Gtk.ApplicationWindow):
	...
	def __init__(self, app):
		...
		self.start_dynamic_exam_button = builder.get_object('start_dynamic_exam_button')
		self.save_dynamic_exam_button = builder.get_object('save_dynamic_exam_button')
		self.load_static_exam_button = builder.get_object('load_static_exam_button')
		self.load_dynamic_exam_button = builder.get_object('load_dynamic_exam_button')
		## ButtonBoxes
