...
class Calibration:
    ...
    def on_start_calibration_clicked(self, widget):
        if self.calibration_test == 0:
            ...
            if self.current_image == 0:
                ...
                self.calibrations = wbb.calibra_medios(self.wiimote, self.calibrations, self.sinal_RT, self.sinal_RB,
                                                       self.sinal_LT, self.sinal_LB, wbb.escala_eu)
                self.calibration_button.set_sensitive(True)
            ...
            if self.current_image == 0:
                ...
                self.calibration_button.set_sensitive(False)
                self.sinal_LB = wbb.captura(self.wiimote, self.progressbar)
                self.calibrations = wbb.calibra_maximos(self.wiimote, self.calibrations, self.sinal_RT, self.sinal_RB,
                                                        self.sinal_LT, self.sinal_LB, wbb.escala_eu)
    ...
    @staticmethod
    def main_window_delete_event(widget, arg2):
        widget.hide()
        return True
    ...
    def __init__(self):
        ...
        self.calibration_by_points_images = ["test_pontos_rt.png", "test_pontos_rb.png", "test_pontos_lt.png",
                                             "test_pontos_lb.png"]
